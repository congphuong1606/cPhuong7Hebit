...
public class EpubWebViewClient extends WebViewClient {
	...
	public void onPageFinished(final WebView view, String url) {
		...
		String reSizeImage = "var image = document.getElementsByTagName('s7')[0];"
		...
		final String strAddStyle = "var newStyle = document.createElement( 'style' );"
				...
				+ strRunFont;
		String reSizeImage45 = "var array = document.getElementsByTagName('s7');"
				+ "var image = document.getElementsByTagName('s7')[array.length - 2];"
				+ "image.setAttribute('style','margin:0 auto auto 0px;height:"
				+ (heightWeb - 80) + "px;width:auto;');";
		EpubWebView.loadJavascript(view, "javascript:" + reSizeImage45);
		String reSizeImage35 = "var image = document.getElementsByTagName('s7')[35];"
				+ "image.setAttribute('style', 'margin: 0 auto;max-width: 100%;');";
		EpubWebView.loadJavascript(view, "javascript:" + reSizeImage35);
		String reSizeImage29 = "var image = document.getElementsByTagName('s7')[29];"
				+ "image.setAttribute('style', 'margin: 0 auto;max-width: 80%;');";
		EpubWebView.loadJavascript(view, "javascript:" + reSizeImage29);
		String reSizeImage23 = "var image = document.getElementsByTagName('s7')[23];"
				+ "image.setAttribute('style', 'margin: 0 auto;max-width: 80%;');";
		EpubWebView.loadJavascript(view, "javascript:" + reSizeImage23);
		String reSizeImage25 = "var image = document.getElementsByTagName('s7')[25];"
				+ "image.setAttribute('style', 'margin: 0 auto;max-width: 80%;');";
		EpubWebView.loadJavascript(view, "javascript:" + reSizeImage25);
		String reSizeImage22 = "var image = document.getElementsByTagName('s7')[22];"
				+ "image.setAttribute('style', 'margin: 0 auto;max-width: 80%;');";
		EpubWebView.loadJavascript(view, "javascript:" + reSizeImage22);
		String reSizeImage32 = "var image = document.getElementsByTagName('s7')[32];"
				+ "image.setAttribute('style', 'margin: 0 auto;max-width: 80%;');";
