...
//	}
	public void changeTextColorToGray(){
		ProgressHUD.show(cont, "", false);
		String strRunFont = "allp = document.getElementsByTagName('p');"
				+ "for (i = 0; i < allp.length; i++) { tagp = allp[i]; tagp.style.colorName = 'colorName"
				+ 0 + "';} ";
		final String strAddStyle = "var newStyle = document.createElement( 'style' );"
				+ "newStyle.appendChild( document.createTextNode( "
				+ "\"@font-face { "
	...
	public void changeTextColorToBlack() {
		...
		//loadJavascript(this, "( function () {javascript:document.body.style.color='black';})");
		loadJavascript(this, "( function () {return 'javascript:document.body.style.color='red';' } ) ()");
//		loadJavascript(this, "javascript:document.getElementById(\"table-1\").style.borderColor = \"black\";");
	...
	public void updateCountPage() {
		...
		final String strGetTop = "var heighArray = [];"
				+ "var top1 = document.getElementsByClassName(\"s1\")[1].offsetTop; "
				+ "var top2 = document.getElementsByClassName(\"s2 s3\")[0].offsetTop;"
				+ "var top3 = document.getElementsByClassName(\"s1\")[3].offsetTop;"
				+ "var top4 = document.getElementsByClassName(\"s1\")[4].offsetTop;"
				+ "var top5 = document.getElementsByClassName(\"s1\")[5].offsetTop;"
				+ "var top6 = document.getElementsByClassName(\"s1\")[6].offsetTop;"
				+ "var top7 = document.getElementsByClassName(\"s1\")[7].offsetTop;"
				+ "var top8 = document.getElementsByClassName(\"s1\")[8].offsetTop;"
				+ "var top9 = document.getElementsByClassName(\"s1\")[9].offsetTop;"
				+ "var top10 = document.getElementsByClassName(\"s1\")[10].offsetTop;"
				+ "var top11 = document.getElementsByClassName(\"s1\")[11].offsetTop;"
				+ "var top12 = document.getElementsByClassName(\"s1\")[12].offsetTop;"
				+ "var top13 = document.getElementsByClassName(\"s1\")[13].offsetTop;"
				+ "var top14 = document.getElementsByClassName(\"s1\")[14].offsetTop;"
				+ "var top15 = document.getElementsByClassName(\"s1\")[15].offsetTop;"
				+ "var top16 = document.getElementsByClassName(\"s1\")[16].offsetTop;"
