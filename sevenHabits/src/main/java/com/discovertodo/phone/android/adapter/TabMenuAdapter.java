...
public class TabMenuAdapter extends BaseAdapter {
	...
	public TabMenuAdapter(BaseActivity activity, ArrayList<String> listItem, ArrayList<Integer> contents) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Integer pageNumber=contents.get(position);
		viewHolder.tvNumber.setText(String.valueOf(pageNumber+1));
//		viewHolder.tvNumber.setText(contents.get(position).getPage());
		try {
			int height = 0;
			...
			// } else
//			viewHolder.tvNumber.setText(contents.get(position).getPage());
//			viewHolder.tvNumber.setText(EpubWebViewClient.arrMenu[position] / height);
